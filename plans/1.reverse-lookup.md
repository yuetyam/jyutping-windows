...
### Notices
- We're NOT going to implement the persistent settings for the Cangjie/Quick variant selections in this roadmap. That will be a future task. This initial implementation would use Cangjie 5 as the default variant.
