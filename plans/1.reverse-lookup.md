Plan: Port the reverse lookup methods from the macOS/Swift version of code.  
Status: Implementing.
...
## Phase 1: Data And Schema Readiness (Implemented)
...
## Phase 2: Shared Reverse Lookup Mode Plumbing (Implemented)
...
## Phase 3: Mandarin Pinyin Reverse Lookup (Implemented)
...
## Phase 4: Cangjie And Quick/Sucheng Reverse Lookup (Implemented)
...
## Phase 5: Stroke (筆畫) Reverse Lookup (Implemented)
...
## Phase 6: Character Decomposition (拆字) Reverse Lookup (Implemented)
