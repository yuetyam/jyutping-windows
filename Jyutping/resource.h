...
#define IDS_DESC_CHARACTER_FORM_HALF_WIDTH        67
#define IDS_DESC_CHARACTER_FORM_FULL_WIDTH        68
#define IDS_DESC_PUNCTUATION_FORM_CANTONESE       69
#define IDS_DESC_PUNCTUATION_FORM_ENGLISH         70
