...
#define CANDIDATE_ROW_PADDING_LEFT      (8.0f)   // Left padding of the row
#define CANDIDATE_ROW_PADDING_RIGHT     (4.0f)   // Right padding of the row
#define CANDIDATE_NUMBER_SPACING        (10.0f)  // Spacing between number and candidate word
#define CANDIDATE_COMMENT_SPACING       (10.0f)  // Spacing between candidate word and comment
