...
class CJyutping : public ITfTextInputProcessorEx,
...
private:
    ...
    BOOL VerifyJyutpingCLSID(_In_ REFCLSID clsid);

    friend LRESULT CALLBACK CJyutping_WindowProc(HWND wndHandle, UINT uMsg, WPARAM wParam, LPARAM lParam);
